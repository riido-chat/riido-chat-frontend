...
function MessageScrollerViewport({
  ...
  return (
    <MessageScrollerPrimitive.Viewport
      ...
      className={cn(
        'scroll-fade-b scrollbar-thumb-rc-gray-200 min-h-0 min-w-0 flex-1 scrollbar-thin scrollbar-track-transparent overflow-y-auto overscroll-contain contain-content data-autoscrolling:scrollbar-thumb-transparent data-autoscrolling:scrollbar-track-transparent',
        className,
      )}
      {...props}
    />
