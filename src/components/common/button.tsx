  ...
  "cursor-pointer font-medium group/button inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding whitespace-nowrap transition-all outline-none select-none focus-visible:border-button-primary-enabled focus-visible:ring-3 focus-visible:ring-button-primary-enabled/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:bg-button-disabled aria-disabled:cursor-default aria-disabled:bg-button-disabled aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        // 운영콘솔 버튼
        'console-primary':
          'gap-2 bg-button-primary-enabled text-label text-rc-gray-0 hover:bg-button-primary-hovered active:bg-button-primary-pressed active:font-semibold disabled:bg-rc-gray-200 disabled:text-label-assistive aria-disabled:bg-rc-gray-200 aria-disabled:text-label-assistive aria-disabled:hover:bg-rc-gray-200 aria-disabled:active:bg-rc-gray-200',
        'console-secondary':
          'gap-2 border-line-normal bg-background-default text-label text-label-normal hover:bg-rc-gray-50 active:bg-background-tertiary active:font-semibold disabled:border-rc-gray-200 disabled:bg-rc-gray-50 disabled:text-label-assistive aria-disabled:border-rc-gray-200 aria-disabled:bg-rc-gray-50 aria-disabled:text-label-assistive aria-disabled:hover:bg-rc-gray-50 aria-disabled:active:bg-rc-gray-50',
        'console-danger':
