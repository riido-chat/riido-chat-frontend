...
function MessageHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'text-muted-foreground flex max-w-full min-w-0 items-center text-xs font-medium',
        className,
      )}
      {...props}
    />
...
function MessageFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'text-muted-foreground flex max-w-full min-w-0 text-xs font-medium group-data-[align=end]/message:justify-end',
        className,
      )}
      {...props}
    />
