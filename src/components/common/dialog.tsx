  ...
  return (
    <DialogPortal container={portalContainer}>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          'bg-background-tertiary data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 border-line-normal fixed top-1/2 left-1/2 z-50 grid w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-6 rounded-xl border-[1.2px] p-6 text-center duration-100 outline-none sm:max-w-100',
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn('flex gap-2 rounded-b-xl [&>button]:flex-1', className)}
      {...props}
    >
      {children}
      {showCloseButton && (
